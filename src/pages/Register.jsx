...
import { submitRegister } from "../lib/login";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 min-h-screen">
            ...
            <div className="flex items-center justify-center md:col-span-2">
                <div className="w-4/5 md:w-3/5 p-auto flex flex-col gap-4">
                    ...
                    <form typeof="submit" className="flex flex-col gap-4" onSubmit={submitRegister}>
                    ...
                    <p className="flex justify-center gap-2">Have An Account? <a className="text-orange-500" href="#">Login</a></p>
                </div>
            </div>
        </div>
    )
